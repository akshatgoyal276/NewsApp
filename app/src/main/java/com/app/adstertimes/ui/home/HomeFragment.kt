...
import com.app.adstertimes.main.MainActivity
import com.app.adstertimes.adapter.PostAdapter
...
import com.app.adstertimes.utils.extensionFunctions.click
import com.app.adstertimes.utils.extensionFunctions.gone
import com.app.adstertimes.utils.extensionFunctions.log
import com.app.adstertimes.utils.extensionFunctions.show
import com.app.adtertimes.databinding.AdNativeLayoutBinding
import com.app.adtertimes.databinding.FragmentHomeBinding
...
class HomeFragment : BaseFragment<FragmentHomeBinding>() {
    ...
    private fun fetchNativeAd(binding: ItemPostAdBinding) {
        val configuration = AdRequestConfiguration.Companion.builder(
            MainActivity.activity, "native_0"
        )
        ...
        AdSterAdLoader.builder().withAdsListener(object : MediationAdListener() {
            ...
            override fun onNativeAdLoaded(ad: MediationNativeAd) {
                ...
                val nativeAdView = AdNativeLayoutBinding.inflate(
                    LayoutInflater.from(MainActivity.activity), adView, true
                )
